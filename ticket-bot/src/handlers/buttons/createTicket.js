...
module.exports = {
  ...
  async execute(interaction) {
    const panelId = interaction.customId.split('_')[3]; // Format: create_ticket_button_panelId_categoryId
    ...
    try {
      ...
      const ticketId = createTicket(guildId, userId, panelId, categoryId, ticketChannel.id);
